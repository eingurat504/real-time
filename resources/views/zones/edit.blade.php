                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" required
                                    ...
                                    value="{{ old('name', $zone->name) }}" placeholder="{{ __('name') }}"/>
                                @error('name')
                                    ...
                                    <option value="">Choose location</option>
                                        @foreach($locations as $location)
                                            <option value="{{ $location->id }}"
                                                {{ old('location_point_id',$zone->location_point_id) == $location->id ? 'selected' : '' }}>{{ $location->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="description" id="description" required
                                    ...
                                    value="{{ old('description', $zone->description) }}" placeholder="{{ __('Description') }}">
                                </textarea>
                                @error('description')
                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                @enderror
